...
const Navbar = () => {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 h-28 transition-all duration-300 ease-in-out ${
        isScrolled
        ...
        <div className="max-w-7xl mx-auto h-full flex justify-between items-center">
          ...
          <div className="hidden lg:block flex-1 max-w-md">
            <SearchBar onCloseMenu={closeMenu} />
          </div>
      ...
      <div
        className={`md:hidden fixed top-28 left-0 right-0 z-40 bg-blue-950/98 backdrop-blur-xl border-b border-blue-900/50 shadow-2xl p-6 transition-all duration-300 ease-out transform ${
          isMenuOpen
